...
export const CareerPointCard = ({img,title,subtitle,dateFrom,dateTo,onClick}) => {
	return (
		<div className='w-1/4 flex flex-col bg-white rounded-2xl shadow-lg py-2 px-4 border border-gray-300 items-center mr-7'>
			<div className='w-full text-right'>
				<i className={'bx bx-dots-horizontal-rounded text-xl cursor-pointer'} onClick={onClick}/>
			</div>
