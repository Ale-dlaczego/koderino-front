...
const PasswordInput = ({ value, onChange }) => {
	...
	return (
		<div className="border-white border-solid border-2 h-11 flex items-center px-3 rounded-md shadow-lg bg-white w-full">
			...
			<input placeholder={'Password'} value={value} onChange={onChange} type={passwordShown? 'text' : 'password'} className="text-opacity-50 outline-none  placeholder-opacity-50 w-full text-sm font-medium text-our-blue" />
