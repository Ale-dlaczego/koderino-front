...
const EmailInput = ({ value, setValue, isError }) => {
	...
	return (
		<div className={`${isError? 'border-red-500' : 'border-white'} border-solid border-2 h-11 flex items-center px-3 rounded-md shadow-lg bg-white w-full mb-5`}>
